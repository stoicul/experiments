...
async function runBenchmark() {
  console.log(`Starting Plain Naive Naive Fixed Properties Benchmark with ${NUM_ENTRIES.toLocaleString()} entries...`);
  ...
  // Save Stats
  saveStats("stats.json", "plain object naive", stats);
}
